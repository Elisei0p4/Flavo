<img width="1920" height="1080" alt="image" src="https://github.com/user-attachments/assets/cb62d413-d73a-44d9-91d1-8a80923d17f2" /># FLAVO - Мир изысканных вкусов
...
<p align="center">
  <img src="docs/screenshots/screenshot_2_menu_page.png" alt="Страница меню FLAVO" width="700"/>
  <br>
  <em>Страница "Меню": полный каталог продуктов с фильтрацией по категориям и тегам.</em>
</p>

<p align="center">
  <img src="docs/screenshots/screenshot_3_product_detail.png" alt="Детальная страница продукта FLAVO" width="700"/>
  <br>
  <em>Детальная страница продукта: подробная информация, состав, рекомендации шефа.</em>
</p>

<p align="center">
  <img src="docs/screenshots/screenshot_4_cart_checkout.png" alt="Корзина и оформление заказа FLAVO" width="700"/>
  <br>
  <em>Корзина и оформление заказа: удобный процесс покупки с применением промокодов.</em>
</p>

<p align="center">
  <img src="docs/screenshots/screenshot_5_recipes.png" alt="Страница рецептов FLAVO" width="700"/>
  <br>
  <em>Страница "Рецепты": вдохновляющие кулинарные идеи с поиском и фильтрацией.</em>
</p>

<p align="center">
  <img src="docs/screenshots/screenshot_6_profile_orders.png" alt="Профиль пользователя и история заказов FLAVO" width="700"/>
  <br>
  <em>Профиль пользователя: личный кабинет с балансом Flavo Coins и историей заказов.</em>
</p>
